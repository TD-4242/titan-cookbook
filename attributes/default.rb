...
default['titan']['rexster'] = {
  ...
  http: {
    ...
    max_post_size: 2_097_152,
    max_header_size: 8192,
    upload_timeout_millis: 30_000,
    thread_pool: {
  ...
  rexpro: {
    server_port: 8184,
    server_host: '0.0.0.0',
    session_max_idle: 1_790_000,
    session_check_interval: 3_000_000,
    connection_max_idle: 180_000,
    connection_check_interval: 3_000_000,
    enable_jmx: false,
    thread_pool: {
      worker: { # upping sizes from default 8/8: https://github.com/tinkerpop/rexster/issues/271
        core_size: 16,
